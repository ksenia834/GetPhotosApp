...
class GetPhotoViewController: UIViewController, ErrorDisplaySupportable {
    ...
    private func setupNavigationBarButtons() {
        switch state {
        case .capturing:
            //            let settings = CustomBarButton(image: UIImage(named: "settings")!, target: self, action: #selector(showSettings))
    ...
    private func showEventsAcessDeniedAlert(message: String) {
        ...
        let cancelAction = UIAlertAction(title: NSLocalizedString("Default.Titles.Cancel", comment: "Default.Titles.Cancel"),
    ...
    @IBAction private func capturePhotoAction(_ sender: Any) {
        ...
        sessionManager.capturePhotoAction { [weak self] image in
            ...
            let previewViewController = storyboard.instantiateViewController(withIdentifier: "ImagePreviewViewController") as? ImagePreviewViewController
            previewViewController.preview = image
    ...
    @IBAction private func showPhotoLibrary(_ sender: Any) {
        ...
        galleryViewController.onImageSelected = { data, title, orientation in
            galleryViewController.dismiss(animated: true, completion: {
                let controller: BaseEditingMenuViewController =
                    AppStoryboards.main.instantiateViewController(withIdentifier: "BaseEditingMenuViewController") as? BaseEditingMenuViewController
